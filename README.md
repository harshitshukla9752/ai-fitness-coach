...
The app keeps visual styling and reusable UI fragments outside the main Streamlit workflow:

* `assets/styles.css` – shared theme, colors, cards, buttons, inputs, tabs, and metric styling.
* `fitness_app/ui.py` – reusable hero/login UI components.
* `docs/PROJECT_STRUCTURE.md` – full folder structure and runtime/database workflow.
