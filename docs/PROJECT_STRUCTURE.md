...
```text
ai-fitness-coach/
├── app.py                         # Main Streamlit app orchestration and coaching workflow
├── fitness_app/                   # Reusable app modules
│   ├── __init__.py
│   └── ui.py                      # Shared Streamlit UI fragments and layout helpers
├── assets/
│   └── styles.css                 # Centralized app theme and component styling
