...
from fitness_app.ui import load_global_styles, render_auth_header, render_hero, render_login_value_card
...
if st.session_state.page == 'Login':
    ...
    with auth_col:
        render_auth_header(st.session_state.use_supabase_auth)
